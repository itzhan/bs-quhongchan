...
import { getAnnouncementPage, createAnnouncement, updateAnnouncement, deleteAnnouncement } from "@/api/classroom";
...
const form = reactive({ id: null as number | null, courseId: null as number | null, title: "", content: "" });
...
function openDialog(title: string, row?: any) {
  ...
  else { Object.assign(form, { id: null, courseId: null, title: "", content: "" }); }
}
  ...
  <div class="main-content">
    <el-card shadow="never">
      <el-form :inline="true" :model="queryParams" class="mb-4">
        ...
        <el-form-item>
          ...
          <el-button type="success" @click="openDialog('发布公告')">发布公告</el-button>
        </el-form-item>
      </el-form>
      ...
      <el-table v-loading="loading" :data="dataList" border stripe>
        ...
        <el-table-column label="操作" width="160" align="center" fixed="right">
          <template #default="{ row }">
            <el-button size="small" type="primary" link @click="openDialog('编辑公告', row)">编辑</el-button>
    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle" width="550px" destroy-on-close>
      <el-form ref="formRef" :model="form" :rules="rules" label-width="90px">
        ...
        <el-form-item label="内容" prop="content"><el-input v-model="form.content" type="textarea" :rows="5" placeholder="请输入公告内容" /></el-form-item>
      </el-form>
      <template #footer>
